...
public class SimulationThread extends Thread {
	...
	public SimulationThread(Manager manager, File workingDir) {
	...
	public void run() {
		while (true) {
			try {
				...
				int result = simulation.run(workingDir);
	...
	public String toString() {
		return "SimulationThread(id = " + super.getId() + "; queue = " + runs.size() + "; completed = " + completed.size() + "; failed = " + failed.size() + ";)";
	}
}
